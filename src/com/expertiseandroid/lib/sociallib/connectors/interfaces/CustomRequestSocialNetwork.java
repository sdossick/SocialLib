...
/**
 * An interface for connectors that provides custom requests capability
...
public interface CustomRequestSocialNetwork extends SocialNetwork {
  ...
  /**
   * Sends a custom non-signed request
   ...
   */
  public ReadableResponse customRequest(String httpMethod, String request) throws FileNotFoundException, MalformedURLException, IOException, OAuthMessageSignerException, OAuthExpectationFailedException, OAuthCommunicationException;
   ...
   * @throws IOException
   */
  public ReadableResponse customRequest(String httpMethod, String request, Map<String, String> bodyParams) throws FileNotFoundException, MalformedURLException, IOException;
