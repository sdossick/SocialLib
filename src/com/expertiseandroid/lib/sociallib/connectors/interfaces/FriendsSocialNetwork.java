...
/**
 * An interface for social networks that give the ability to have "friends"
...
public interface FriendsSocialNetwork extends AuthorizedSocialNetwork{
   ...
   */
  public List<? extends User> getFriends() throws MalformedURLException, IOException, JSONException, SAXException, ParserConfigurationException, NotAuthentifiedException;
